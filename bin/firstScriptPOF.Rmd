...
#min.model = lm(tme ~ 1, data=lala$masculino[3:length(lala$masculino)])
#biggest <- formula(lm(tme~.,lala$masculino[3:length(lala$masculino)]))
#biggest
#fwd.model = step(min.model, direction='forward', scope=biggest)



#fitMasculino<-lm(data = lala$masculino, formula = tme ~ kcal..g..a + PROTEÍNA..g..a + LIPÍDEOS.TOTAIS..g..a + CARBOIDRATO..g..a+ FIBRA.ALIMENTAR.TOTAL..g..a + CÁLCIO..mg..a  + MANGANÊS..mg..a + FERRO..mg..a + SÓDIO..mg..a + COBRE..mg..a + ZINCO..mg..a + SELÊNIO..mcg..a + RETINOL..mcg..a + TIAMINA..VITAMINA.B1...mg..a + RIBOFLAVINA..VITAMINA.B2...mg..a + PIRIDOXINA..VITAMINA.B6...mg..a + COBALAMINA..VITAMINA.B12...mcg..a + FOLATO..EQUIVALENTE.DIETÉTICO.DE.FOLATO...mcg..a + VITAMINA.D..CALCIFEROL...mcg..a + VITAMINA.E..TOTAL.DE.ALPHA.TOCOPHEROL...mg..a + VITAMINA.C..mg..a + ÁCIDOS.GRAXOS.SATURADOS..g..a + ÁCIDOS.GRAXOS.MONOINSATURADOS..g..a + ÁCIDOS.GRAXOS.POLIINSATURADOS..g..a+ ÁCIDOS.GRAXOS.TRANS.TOTAL..g..a + AÇÚCAR.TOTAL..g..a)
#summary(fitMasculino)

#fitFeminino<-lm(data = lala$feminino, formula = tme ~ kcal..g..a + PROTEÍNA..g..a + LIPÍDEOS.TOTAIS..g..a + CARBOIDRATO..g..a+ FIBRA.ALIMENTAR.TOTAL..g..a + CÁLCIO..mg..a  + MANGANÊS..mg..a + FERRO..mg..a + SÓDIO..mg..a + COBRE..mg..a + ZINCO..mg..a + SELÊNIO..mcg..a + RETINOL..mcg..a + TIAMINA..VITAMINA.B1...mg..a + RIBOFLAVINA..VITAMINA.B2...mg..a + PIRIDOXINA..VITAMINA.B6...mg..a + COBALAMINA..VITAMINA.B12...mcg..a + FOLATO..EQUIVALENTE.DIETÉTICO.DE.FOLATO...mcg..a + VITAMINA.D..CALCIFEROL...mcg..a + VITAMINA.E..TOTAL.DE.ALPHA.TOCOPHEROL...mg..a + VITAMINA.C..mg..a + ÁCIDOS.GRAXOS.SATURADOS..g..a + ÁCIDOS.GRAXOS.MONOINSATURADOS..g..a + ÁCIDOS.GRAXOS.POLIINSATURADOS..g..a+ ÁCIDOS.GRAXOS.TRANS.TOTAL..g..a + AÇÚCAR.TOTAL..g..a)
#summary(fitFeminino)
