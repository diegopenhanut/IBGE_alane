...
pop_mas<-read.table(file = "data/pop_2011_mas.csv",skip = 4, nrows = 26,
  sep = ";", header = TRUE, fileEncoding =  "Latin1", na.strings="-", dec = ",")
pop_mas$genero="masculino"

pop_fem<-read.table(file = "data/pop_2011_mas.csv",skip = 4, nrows = 26,
  sep = ";", header = TRUE, fileEncoding =  "Latin1", na.strings="-", dec = ",")
pop_fem$genero="feminino"
...
mortalidade <- merge(x = obito_neo, y = pop, by= c("Unidade.da.Federação", "genero"))
mortalidade <- mortalidade[,c("Unidade.da.Federação", "genero", "populacaoAcima60", "obitosAcima60")]
